...
class Map extends Component {
  ...
  setInitialMarkers() {
    for (var i = 0; i< this.props.mymarkers.length; i++) {
      var position = {lat: this.props.mymarkers[i].lat, lng: this.props.mymarkers[i].lng};
      var title = this.props.mymarkers[i].name;
  ...
  render() {
    return (
      <div className='map-container'{...this.props}>
      <div id='LFKMap'></div>
      </div>
    )
  }
